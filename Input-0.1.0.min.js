...
if(!this.is_function(b))throw'function(ordered_combo) expects "callback" to be function';var f=this.string_to_array(a);if(!this.is_empty(f)){this.register_keys(f,e);var g=this.store_sizetable(f.length,e);this.store_keypackage(a,d,b,c,g,e);d&&(this.add_to_first(l[f[0]],g,e),p.add(e.machine,f))}},remove_firstoid:function(a,b,c){a=c.first_to_id[a];c=a.length;for(var d=0;d<c;d++)if(a[d]==b){a.splice(d,1);break}},remove_package:function(a,b){var c=b.keys_package;if(this.is_empty(c))return!1;for(var d=
b.size_table,e=d[a.length],f=e.length,g,h=0;h<f;h++)if(g=e[h],this.same_array(a,c[g].key))return d[a.length].splice(h,1),delete c[g],this.remove_firstoid(l[a[0]],g,b),!0;return!1},remove_activekeys:function(a,b){for(var c=b.active_keys,d=a.length,e=0;e<d;e++)1==c[l[a[e]]]?delete c[l[a[e]]]:c[l[a[e]]]--},remove_machine:function(a,b){var c=b.machine,d=a.length,e,f;e=l[a[0]];1==c.start[e]?delete c.start[e]:c.start[e]--;for(var g=0;g<d-1;g++)e=l[a[g]],f=l[a[g+1]],1==c[e][f]?delete c[e][f]:c[e][f]--},
destroy_combo:function(a,b){var c=this.string_to_array(a);this.remove_package(c,b)&&(this.remove_activekeys(c,b),this.remove_machine(c,b))},makeup_keyup_obj:function(a,b,c){c={};c.current=a;c.id=b;c.pass=1;c.v=!0;return c},timer:function(a,b,c,d){setTimeout(function(a){return function(){var f=d.keyup_buffer;if(!a.is_empty(f))for(var g=0;g<=c&&!a.is_empty(f);g++)if(b==f[g].id){f[g].v=!1;break}}}(this),a)},fire:function(a,b){for(var c=b.keys_package,d=a.length,e,f=0;f<d;f++)e=c[a[f]].callback,c[a[f]].count++,
e()},fire_keydown:function(a,b){},fire_keyup:function(a,b){if(this.hasProp(b.active_keys,a)){for(var c=b.keyup_buffer,d=b.keys_package,e=b.first_to_id,f=b.machine,g=[],h,k=0;k<c.length;k++)h=c[k],h.v?this.hasProp(f[h.current],a)?h.pass+1==d[h.id].key.length?(g.push(h.id),c.splice(k,1),k--):(h.current=a,h.pass++):(c.splice(k,1),k--):(c.splice(k,1),k--);if(this.hasProp(f.start,a))for(e=e[a],f=e.length,k=0;k<f;k++)1==d[e[k]].key.length?g.push(e[k]):(h=d[e[k]].time,c.push(this.makeup_keyup_obj(a,e[k],
b)),h&&this.timer(h,e[k],k,b));0<g.length&&this.fire(g,b)}else b.keyup_buffer=[]},count:function(a,b){var c=0,d=b.keys_package,e=b.size_table,f=this.string_to_array(a),e=e[f.length];if(this.is_empty(d)||void 0==e)return c;for(var g=e.length,h,k=0;k<g;k++)if(h=e[k],this.same_array(f,d[h].key)){c=d[h].count;break}return c}},n={};n.Listener=function(){function a(a){this.active_keys={};this.keys_package={};this.size_table={};this.first_to_id={};this.machine={};this.keydown_buffer=[];this.keyup_buffer=
[];a=a||document.body;m.attach_event(a,"keyup",function(a){return function(b){return a.user_input(b,!1)}}(this))}a.extend=function(b){for(var c in b)a.prototype[c]=b[c]};a.extend({unordered_combo:function(a,c,d){m.add_combo(a,c,d,!1,this)},ordered_combo:function(a,c,d){m.add_combo(a,c,d,!0,this)},delete_combo:function(a){m.destroy_combo(a,this)},user_input:function(a,c){var d=a.keyCode;c?m.fire_keydown(d,this):m.fire_keyup(d,this)},count_times:function(a){return m.count(a,this)},get_keypackage:function(){return this.keys_package},
