...
a)){for(var b=c.keyup_buffer,d=c.keys_package,e=c.first_to_id,f=c.machine,g=[],h,m,l=0;l<b.length;l++)h=b[l],m=d[h.id],h.v?this.hasProp(f[h.current],a)&&k[m.key[h.pass]]==a?h.pass+1==m.key.length?(g.push(h.id),b.splice(l,1),l--):(h.current=a,h.pass++):(b.splice(l,1),l--):(b.splice(l,1),l--);if(this.hasProp(f.start,a))for(e=e[a],f=e.length,l=0;l<f;l++)1==d[e[l]].key.length?g.push(e[l]):(h=d[e[l]].time,b.push(this.makeup_keyup_obj(a,e[l],c)),h&&this.timer(h,e[l],l,c));0<g.length&&this.fire(g,c)}else c.keyup_buffer=
[]},count:function(a,c){var b=0,d=c.keys_package,e=c.size_table,f=this.string_to_array(a),e=e[f.length];if(this.is_empty(d)||void 0==e)return b;for(var g=e.length,h,k=0;k<g;k++)if(h=e[k],this.same_array(f,d[h].key)){b=d[h].count;break}return b}},n={};n.Listener=function(){function a(a){this.active_keys={};this.keys_package={};this.size_table={};this.first_to_id={};this.machine={};this.keydown_buffer=[];this.keyup_buffer=[];a=a||document.body;m.attach_event(a,"keyup",function(a){return function(c){return a.user_input(c,
