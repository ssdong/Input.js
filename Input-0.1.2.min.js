...
c))return!1;return!0},cross_browser:function(){var a=this.get_user_browser();-1!=a.indexOf("Opera")&&12>a.substring(6,a.length)?this.extend(h,q):-1!=a.indexOf("Firefox")&&15>a.substring(8,a.length)?this.extend(h,r):-1!=a.indexOf("Firefox")&&15<=a.substring(8,a.length)&&this.extend(h,t)},get_user_browser:function(){var a=navigator.userAgent,c,b;b=a.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i)||[];if(/trident/i.test(b[1]))return c=/\brv[ :]+(\d+)/g.exec(ua)||[],"IE "+(c[1]||
...
this.store_keypackage(a,d,c,b,g,e);d&&(this.add_to_first(h[f[0]],g,e),u.add(e.machine,f))}},remove_firstoid:function(a,c,b){a=b.first_to_id[a];b=a.length;for(var d=0;d<b;d++)if(a[d]==c){a.splice(d,1);break}},remove_package:function(a,c){var b=c.keys_package;if(this.is_empty(b))return!1;for(var d=c.size_table,e=d[a.length],f=e.length,g,k=0;k<f;k++)if(g=e[k],this.same_array(a,b[g].key))return d[a.length].splice(k,1),delete b[g],this.remove_firstoid(h[a[0]],g,c),!0;return!1},remove_activekeys:function(a,
c){for(var b=c.active_keys,d=a.length,e=0;e<d;e++)1==b[h[a[e]]]?delete b[h[a[e]]]:b[h[a[e]]]--},remove_machine:function(a,c){var b=c.machine,d=a.length,e,f;e=h[a[0]];1==b.start[e]?delete b.start[e]:b.start[e]--;for(var g=0;g<d-1;g++)e=h[a[g]],f=h[a[g+1]],1==b[e][f]?delete b[e][f]:b[e][f]--},destroy_combo:function(a,c){if(!this.is_string(a))throw'function(destroy_combo) expects "keys" to be string';var b=this.string_to_array(a);this.remove_package(b,c)&&(this.remove_activekeys(b,c),this.remove_machine(b,
c))},destroy_all:function(a){a.active_keys={};a.keys_package={};a.size_table={};a.first_to_id={};a.machine={};a.keydown_buffer=[];a.keyup_buffer=[]},makeup_keyup_obj:function(a,c,b){b={};b.current=a;b.id=c;b.pass=1;b.v=!0;return b},timer:function(a,c,b,d){setTimeout(function(a){return function(){var f=d.keyup_buffer;if(!a.is_empty(f))for(var g=0;g<=b&&!a.is_empty(f);g++)if(c==f[g].id){f[g].v=!1;break}}}(this),a)},fire:function(a,c){for(var b=c.keys_package,d=a.length,e,f=0;f<d;f++)e=b[a[f]].callback,
b[a[f]].count++,e()},fire_keydown:function(a,c){},fire_keyup:function(a,c){if(this.hasProp(c.active_keys,a)){for(var b=c.keyup_buffer,d=c.keys_package,e=c.first_to_id,f=c.machine,g=[],k,m,l=0;l<b.length;l++)k=b[l],m=d[k.id],k.v?this.hasProp(f[k.current],a)&&h[m.key[k.pass]]==a?k.pass+1==m.key.length?(g.push(k.id),b.splice(l,1),l--):(k.current=a,k.pass++):(b.splice(l,1),l--):(b.splice(l,1),l--);if(this.hasProp(f.start,a))for(e=e[a],f=e.length,l=0;l<f;l++)1==d[e[l]].key.length?g.push(e[l]):(k=d[e[l]].time,
b.push(this.makeup_keyup_obj(a,e[l],c)),k&&this.timer(k,e[l],l,c));0<g.length&&this.fire(g,c)}else c.keyup_buffer=[]},count:function(a,c){var b=0,d=c.keys_package,e=c.size_table,f=this.string_to_array(a),e=e[f.length];if(this.is_empty(d)||void 0==e)return b;for(var g=e.length,k,h=0;h<g;h++)if(k=e[h],this.same_array(f,d[k].key)){b=d[k].count;break}return b}},n={};n.Listener=function(){function a(a){this.active_keys={};this.keys_package={};this.size_table={};this.first_to_id={};this.machine={};this.keydown_buffer=
[];this.keyup_buffer=[];a=a||document.body;m.cross_browser();m.attach_event(a,"keyup",function(a){return function(c){return a.user_input(c,!1)}}(this))}a.extend=function(c){for(var b in c)a.prototype[b]=c[b]};a.extend({unordered_combo:function(a,b,d){m.add_combo(a,b,d,!1,this)},ordered_combo:function(a,b,d){m.add_combo(a,b,d,!0,this)},delete_combo:function(a){m.destroy_combo(a,this)},delete_all:function(){m.destroy_all(this)},user_input:function(a,b){var d=a.keyCode;b?m.fire_keydown(d,this):m.fire_keyup(d,
this)},count_times:function(a){return m.count(a,this)},get_keypackage:function(){return this.keys_package},get_sizetable:function(){return this.size_table},get_activekeys:function(){return this.active_keys},get_id:function(){return this.first_to_id},get_machine:function(){return this.machine},get_buffer:function(){return this.keyup_buffer}});return a}();"undefined"!==typeof module&&"undefined"!==typeof module.exports?module.exports=n:"function"===typeof define&&define.amd?define([],function(){return n}):
p.Input=n})(window);